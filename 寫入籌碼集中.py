...
class dbHandle:
    ...
    def CreateTable( self ):
        ...
        cmd = ''' CREATE TABLE CONCENTRATION
        (
        stock varchar(10) CHARACTER SET utf8 NOT NULL PRIMARY Key,
        date DATE NOT NULL,
...
def main():
    ...
    db = dbHandle( 'localhost', 'StockDB', 'root', "pRegaine" )
    # db.ResetTable( 'CONCENTRATION' )
    # db.CreateTable(  )

    cmd = 'SELECT stock, date FROM CONCENTRATION ORDER BY date DESC '
